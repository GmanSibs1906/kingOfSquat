...
class AppColor {
  ...
  static Color homePagePlainColor = const Color(0xFFa2a2b1);
  static Color secondPageTopIconColor = const Color(0xFFb7bce8);
  static Color secondPageTitleColor = const Color(0xFFfefeff);
  static Color secondPageContainerGradient1stColor = const Color(0xff0f21ad);
  static Color secondPageContainerGradient2ndColor = const Color(0xFF6d8dea);
